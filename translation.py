...
Myself  𝐒𝐡𝐞𝐧𝐋𝐚𝐧 and I'm not Bewafa 
...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thank you <a href='https://t.me/devine_bots'>**AzRdeveloper**</a> for helping us in this journey ❤️"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds.\n\n@AzRdeveloper"
    SAVED_CUSTOM_THUMB_NAIL = "Custom video / file thumbnail saved. This image will be used in the video / file."
    DEL_ETED_CUSTOM_THUMB_NAIL = "✅ Custom thumbnail cleared succesfully."
    CUSTOM_CAPTION_UL_FILE = "{}"
    NO_VOID_FORMAT_FOUND = "ERROR...\n<b>AzRdeveloper</b> said: {}"
...
Contact ADMIN if any error occurs @AzRdeveloper"""
...
The 𝗔𝘇𝗥𝗱𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿 has not allowed me to upload files from the urls which is send by an unAuthorised member.
